...
cover:
	go test -cover -coverpkg github.com/syzspectroom/manta,github.com/syzspectroom/manta/vbkv -coverprofile /tmp/manta.cov -v
...
update-protobufs:
	...
	rm -rf dota/gametoolevents.proto dota/dota_gcmessages_common_bot_script.proto dota/steammessages_base.proto dota/steammessages_clientserver_login.proto dota/dota_messages_mlbot.proto dota/steamdatagram_*.proto dota/steamnetworkingsockets_*.proto dota/*steamworks*.proto dota/tensorflow
